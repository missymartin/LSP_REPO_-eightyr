...
class ShoppingCartTest {
	...
	public void testAddItem() {
		...
		//0 price item
		Throwable exception2 = assertThrows( IllegalArgumentException.class, ()->cart1.addItem("Nothing", 0.0));
		assertEquals("Price cannot be negative.", exception2.getMessage());
	}
	...
	public void testTotalCost() {
		...
		//empty cart
		assertEquals(cart2.getTotalCost(),0.0);
		//discount cart
		cart1.applyDiscountCode("SAVE10");
		assertEquals(cart1.getTotalCost(),2.7);
	}
